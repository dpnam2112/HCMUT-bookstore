...
function OffcanvasMenu() {
    return (
      <div className="offcanvas-lg offcanvas-end overflow-auto p-4 p-lg-0" style={{ width: '250px' }} data-bs-scroll="true" tabIndex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
        <div className="card w-100 border border-0 mb-5">
          ...
          <ul className="list-group list-group-flush border">
            <li className="list-group-item border border-0 text-hover-primary"><a href="#" className="text-decoration-none text-dark text-hover-primary">Trang chủ</a></li>
            <li className="list-group-item border border-0 text-hover-primary"><a href="#" className="text-decoration-none text-dark text-hover-primary">Sản phẩm</a></li>
  ...
  function SortingOptions() {
    return (
      <div>
        <h6 className="d-inline-block me-5">Ưu tiên xem: </h6>
        <div className="form-check form-check-inline text-hover-primary">
          <input className="form-check-input me-2 border rounded-0" type="radio" id="filter-cost-increase" value="" name="filter-cost-sort" />
          <label className="form-check-label" htmlFor="filter-cost-increase">Hàng mới nhất</label>
        </div>
        <div className="form-check form-check-inline text-hover-primary">
          <input className="form-check-input me-2 border rounded-0" type="radio" id="filter-cost-decrease" value="" name="filter-cost-sort" />
          <label className="form-check-label" htmlFor="filter-cost-decrease">Hàng cũ nhất</label>
        </div>
        <div className="form-check form-check-inline text-hover-primary">
          <input className="form-check-input me-2 border rounded-0" type="radio" id="filter-cost-increase" value="" name="filter-cost-sort" />
          <label className="form-check-label" htmlFor="filter-cost-increase">Giá tăng dần</label>
        </div>
        <div className="form-check form-check-inline text-hover-primary">
          <input className="form-check-input me-2 border rounded-0" type="radio" id="filter-cost-decrease" value="" name="filter-cost-sort" />
          <label className="form-check-label" htmlFor="filter-cost-decrease">Giá giảm dần</label>
        </div>
      </div>
    );
  }
